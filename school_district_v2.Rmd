---
title: "District Intelligence Pipeline -- Inference, Automated Reporting & Archiving"
output:
  html_notebook:
    toc: true
    toc_depth: 2
...
## Step 2c: POST-HOC COMPARISON (new -- omnibus test alone doesn't say WHICH schools differ)
